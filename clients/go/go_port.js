...
function GoPortObject(container_val) {
    ...
    this.transmitStringData = function (str_val) {
        ...
        this.sessionMgrObject().enQueueSessionData(this.sessionObject());
    };
    ...
    this.theSessionObject = new SessionObject(this.rootObject(), this, this.configObject().myName(), this.configObject().opponentName());
